...
const ConstructionPage = () => {
  return (
    <div className="w-full min-h-screen overflow-hidden md:overflow-auto bg-black text-white flex flex-col items-center md:gap-0 gap-8 justify-center p-0 m:p-6">
